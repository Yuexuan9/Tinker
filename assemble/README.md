...
Long press the remote control `Y`, confirm whether the angle is reset after hearing the buzzer sound. It is recommended to repeat the first calibration 2-3 times to ensure that all joint calibration is completed.
